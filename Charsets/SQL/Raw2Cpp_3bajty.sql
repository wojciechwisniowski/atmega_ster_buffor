...
BEGIN
  ...
  Raw2Cpp.gt_ToOutput.DELETE(/*Ä*/fiHex2Num('80'));
  Raw2Cpp.gt_ToOutput.DELETE(/*©*/fiHex2Num('A9'));
  Raw2Cpp.gt_ToOutput.DELETE(/*Æ*/fiHex2Num('AE'));
--  Raw2Cpp.gt_ToOutput.DELETE(/*∞*/fiHex2Num('B0'));
  Raw2Cpp.gt_ToOutput.DELETE(/*±*/fiHex2Num('B1'));
  Raw2Cpp.gt_ToOutput.DELETE(/*µ*/fiHex2Num('B5'));
  ...
  END LOOP;
  Raw2Cpp.gt_ToOutput.DELETE(/*∞*/fiHex2Num('B0'));
  Raw2Cpp.gt_ToOutput(/*π*/fiHex2Num('B9')) := /*•*/fiHex2Num('A5');
  Raw2Cpp.gt_ToOutput(/*Ê*/fiHex2Num('E6')) := /*∆*/fiHex2Num('C6');
  Raw2Cpp.gt_ToOutput(/*Í*/fiHex2Num('EA')) := /* */fiHex2Num('CA');
  Raw2Cpp.gt_ToOutput(/*≥*/fiHex2Num('B3')) := /*£*/fiHex2Num('A3');
  Raw2Cpp.gt_ToOutput(/*Ò*/fiHex2Num('F1')) := /*—*/fiHex2Num('D1');
  Raw2Cpp.gt_ToOutput(/*Û*/fiHex2Num('F3')) := /*”*/fiHex2Num('D3');
  Raw2Cpp.gt_ToOutput(/*ú*/fiHex2Num('9C')) := /*å*/fiHex2Num('8C');
  Raw2Cpp.gt_ToOutput(/*ø*/fiHex2Num('BF')) := /*Ø*/fiHex2Num('AF');
  Raw2Cpp.gt_ToOutput(/*ü*/fiHex2Num('9F')) := /*è*/fiHex2Num('8F');
...
BEGIN
  ...
  LOOP
    ...
    IF gt_ToOutput.EXISTS(vi_Char) AND gt_ToOutput(vi_Char)=vi_Char THEN
      ...
      vv_Text := vv_Text||
        'uint8_t cv_CS'||gv_SetName||fvNum2Hex(vi_Char)||'[] /*'||CHR(vi_Char)||'*/ PROGMEM = {/*W,H,YOffXbXa*/'||gt_Width(vi_Char)||','||vi_Height||
  ...
  END IF;
  vv_Text := vv_Text||
    'uint8_t cv_CS'||gv_SetName||'None [] /*brak znaku w charsecie*/ PROGMEM = {/*W,H,YOffXbXa*/3,4'||
    ',0x'||fvNum2Hex(vi_YOffs) || fvNum2Hex(TRUNC(gi_MaxXSpace/4)+MOD(gi_MaxXSpace,4))||',15,9,15};';
  gi_Bytes := gi_Bytes+6;
